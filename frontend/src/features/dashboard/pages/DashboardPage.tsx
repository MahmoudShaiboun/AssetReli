...
import { SensorData, HistoricalData } from '../../../api/types';
    ...
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={3}>
          <Card>
            <CardContent>
              ...
              <Typography variant="h3">{dashboardData?.total_predictions || 0}</Typography>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} md={3}>
          <Card>
            <CardContent>
              <Typography color="textSecondary" gutterBottom>Feedback Collected</Typography>
              <Typography variant="h3">{dashboardData?.total_feedback || 0}</Typography>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} md={3}>
          <Card sx={{ bgcolor: latestValues?.prediction === 'normal' ? 'success.light' : 'warning.light' }}>
            <CardContent>
              <Typography color="textSecondary" gutterBottom>Latest ML Prediction</Typography>
              <Typography variant="h5">{latestValues?.prediction || 'Waiting...'}</Typography>
            </CardContent>
          </Card>
        </Grid>
        ...
        {latestValues && (
          <>
            <Grid item xs={12} md={3}>
              <Card>
                <CardContent>
                  <Typography color="textSecondary" gutterBottom>Motor Temp</Typography>
                  <Typography variant="h4">{latestValues.motorTemp?.toFixed(1) || 'N/A'}°C</Typography>
                </CardContent>
              </Card>
            </Grid>
            <Grid item xs={12} md={3}>
              <Card>
                <CardContent>
                  <Typography color="textSecondary" gutterBottom>Motor Vibration</Typography>
                  <Typography variant="h4">{latestValues.motorVib?.toFixed(2) || 'N/A'} Hz</Typography>
                </CardContent>
              </Card>
            </Grid>
            <Grid item xs={12} md={3}>
              <Card>
                <CardContent>
                  <Typography color="textSecondary" gutterBottom>Pump Temp</Typography>
                  <Typography variant="h4">{latestValues.pumpTemp?.toFixed(1) || 'N/A'}°C</Typography>
                </CardContent>
              </Card>
            </Grid>
            <Grid item xs={12} md={3}>
              <Card>
                <CardContent>
                  <Typography color="textSecondary" gutterBottom>Pump Ultrasonic</Typography>
                  <Typography variant="h4">{latestValues.pumpUltra?.toFixed(1) || 'N/A'} dB</Typography>
                </CardContent>
              </Card>
            </Grid>
          </>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 2 }}>
            <Typography variant="h6" gutterBottom>Motor Temperature Trend</Typography>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 2 }}>
            <Typography variant="h6" gutterBottom>Motor Vibration Trend</Typography>
            <ResponsiveContainer width="100%" height={250}>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 2 }}>
            <Typography variant="h6" gutterBottom>Pump Temperature Trend</Typography>
            <ResponsiveContainer width="100%" height={250}>
              <AreaChart data={historicalData}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="timestamp" />
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 2 }}>
            <Typography variant="h6" gutterBottom>Pump Ultrasonic Trend</Typography>
            <ResponsiveContainer width="100%" height={250}>
              <LineChart data={historicalData}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="timestamp" />
        ...
        <Grid item xs={12}>
          <Paper sx={{ p: 2 }}>
            <Typography variant="h6" gutterBottom>Recent ML Predictions & Anomalies (Live)</Typography>
                  ...
                  return (
                    ...
                    >
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <Box>
                          {isAnomaly && (
                            <Chip label="ANOMALY" color="error" size="small" sx={{ mr: 1 }} />
                          )}
                          <Chip
